...
import me.alpha432.oyvey.features.modules.hud.BattleHudModule;
import me.alpha432.oyvey.features.modules.hud.CoordinatesHudModule;
import me.alpha432.oyvey.features.modules.hud.CobblemonActiveHudModule;
...
public class ModuleManager implements Jsonable, Util {
    ...
    public void init() {
        ...
        register(new CobblemonActiveHudModule());
        register(new BattleHudModule());
        register(new HudEditorModule());
        register(new ClickGuiModule());
        register(new NotificationsModule());
        register(new CobblemonSpawnModule());
